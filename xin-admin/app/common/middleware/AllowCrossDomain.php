...
class AllowCrossDomain extends \think\middleware\AllowCrossDomain
{
    ...
    protected $header = [
        ...
        'Access-Control-Allow-Headers'     => 'X-Token, X-Admin-Token, Authorization, Content-Type, If-Match, If-Modified-Since, If-None-Match, If-Unmodified-Since, X-CSRF-TOKEN, X-Requested-With',
    ];
